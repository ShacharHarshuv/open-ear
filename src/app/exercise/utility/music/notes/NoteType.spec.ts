...
export function noteOfType(noteType: NoteType): jasmine.AsymmetricMatcher<Note> {
  return {
    asymmetricMatch(note: Note, customTesters: ReadonlyArray<jasmine.CustomEqualityTester>): boolean {
